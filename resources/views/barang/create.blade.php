                                ...
                                <form method="POST" action="{{ route('barang.store') }}">
                                    ...
                                    <div class="row">
                                        <div class="mb-3 col-md-12">
                                            ...
                                            <input type="text" name="nama_barang" class="form-control border border-2 p-2" value="{{ old('nama_barang') }}">
                                            @error('nama_barang')
                                        ...
                                        <div class="mb-3 col-md-12">
                                            ...
                                            <select class="form-control border border-2 p-2 kelompok" name="kelompok_barang">
                                                ...
                                                @foreach ($kelompokBarang as $item)
                                                    <option value="{{ $item->id }}" {{ old('kelompok_barang') == $item->id ? 'selected' : '' }}>
                                                        {{ $item->nama_kelompok }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        ...
                                        {{-- <div class="mb-3 col-md-12">
                                            ...
                                            <input type="number" name="harga_beli" class="form-control border border-2 p-2" value="{{ old('harga_beli') }}">
                                            @error('harga_beli')
                                                <p class="text-danger inputerror">{{ $message }}</p>
                                            @enderror
                                        </div> --}}
                                        ...
                                        {{-- <div class="mb-3 col-md-12">
                                            ...
                                            <input type="number" name="harga_jual" class="form-control border border-2 p-2" value="{{ old('harga_jual') }}">
                                            @error('harga_jual')
                                                <p class="text-danger inputerror">{{ $message }}</p>
                                            @enderror
                                        </div> --}}
                                        ...
                                        <div class="mb-3 col-md-12">
                                            ...
                                            <select class="form-control border border-2 p-2 lokasi" name="lokasi_barang">
                                                ...
                                                @foreach ($lokasiBarang as $item)
                                                    <option value="{{ $item->id }}" {{ old('lokasi_barang') == $item->id ? 'selected' : '' }}>
                                                        {{ $item->nama_lokasi }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="mb-3 col-md-12">
                                            ...
                                            <textarea class="form-control border border-2 p-2" name="keterangan">{{ old('keterangan') }}</textarea>
                                            @error('keterangan')
                                                <p class="text-danger inputerror">{{ $message }}</p>
                                            @enderror
                                        </div>
