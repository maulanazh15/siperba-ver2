<x-layout bodyClass="g-sidenav-show bg-gray-200">
    ...
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg">
        <!-- Navbar -->
        <x-navbars.navs.auth titlePage="Tambah Data Project" page="Transaksi Barang Keluar"></x-navbars.navs.auth>
        <!-- End Navbar -->
                                ...
                                <form method="POST" action="{{ route('project.store') }}">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="nama_project"
                                            class="form-control border border-2 p-2" value="{{ old('nama_project') }}">
                                        @error('nama_project')
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="date" name="tanggal_pesan"
                                            class="form-control border border-2 p-2" value="{{ old('tanggal_pesan') }}">
                                        @error('tanggal_pesan')
                                            <p class="text-danger inputerror">{{ $message }}</p>
                                        @enderror
                                    </div>
                                    <div class="mb-3">
                                        ...
                                        <select class="form-control border border-2 p-2 pilihBarang" name="barang_id" onchange="">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select class="form-control border border-2 p-2" name="status">
                                            ...
                                            <option value="Dalam Proses"
                                                {{ old('status') == 'Dalam Proses' ? 'selected' : '' }}>Dalam Proses
                                            </option>
